...
function Dumper:DumpLocals(level)
	...
	while name do
		...
		elseif type(value) == "function" then
			...
			if info.what == "C" then
				self:add_f("%s%s = C %s\r\n", prefix, name, (fun_name and ("function: " .. fun_name) or value))
			else
				...
				if fun_name then
					...
					self:add_f(
						"%s%s = Lua function (defined at line %d of chunk %s)\r\n",
						prefix,
						name,
						info.linedefined,
						source
