...
CoreEvents::CoreEvents(EventManager &eventManager) noexcept
{
	...
	TE_CORE_EVENTS_GEN_INIT(_keyboardRelease, "KeyUp");
	TE_CORE_EVENTS_GEN_INIT(_keyboardRepeat, "KeyRepeat");
	TE_CORE_EVENTS_GEN_INIT(_keyboardAdded, "KeyAdded");
	TE_CORE_EVENTS_GEN_INIT(_keyboardRemoved, "KeyRemoved");
	TE_CORE_EVENTS_GEN_INIT(_mouseMotion, "MouseMove");
