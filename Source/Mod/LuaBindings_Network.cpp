...
void LuaBindings::InstallNetwork(sol::state &lua, Context &context) noexcept
{
	...
	TE_LB_USERTYPE(
	    EventLocalClientDisconnectData,
	...
	TE_LB_USERTYPE(
	    EventLocalServerDisconnectData,
	...
	TE_LB_USERTYPE(
	    EventReliableUDPClientConnectData,
	...
	TE_LB_USERTYPE(
	    EventReliableUDPClientDisconnectData,
	...
	TE_LB_USERTYPE(
	    EventReliableUDPClientMessageData,
	...
	TE_LB_USERTYPE(
	    EventReliableUDPServerConnectData,
	...
	TE_LB_USERTYPE(
	    EventReliableUDPServerDisconnectData,
	...
	TE_LB_USERTYPE(
	    EventReliableUDPServerMessageData,
