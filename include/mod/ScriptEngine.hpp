...
namespace tudov
{
	...
	struct IScriptEngine : IEngineComponent
	{
		...
		virtual void InitializeScriptFunction(ScriptID scriptID, std::string_view scriptName, sol::protected_function &function, std::string_view sandboxKey = "") = 0;
		/*
		 * Dangerous function!
		 */
	...
	class ScriptEngine : public IScriptEngine
	{
	  ...
	  public:
		...
		void InitializeScriptFunction(ScriptID scriptID, std::string_view scriptName, sol::protected_function &function, std::string_view sandboxKey = "") noexcept override;
